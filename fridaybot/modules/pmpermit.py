...
if not PMPERMIT_PIC:
    WARN_PIC = "https://telegra.ph/file/bea99e1c320e036fb9268.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Cr:@Rafewm"
)
...
USER_BOT_NO_WARN = (
    "**Hello, This is Admin PM Protection Service ⚠️**\n\n"
